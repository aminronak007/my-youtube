...
import { toggleMenu } from "../../store/App/AppSlice";
import { YOUTUBE_SEARCH_API } from "../../utils/constants";
import { cacheResults } from "../../store/Search/SearchSlice";
  ...
  return (
    <div className="grid grid-flow-col p-5 shadow-lg  ">
      ...
      <div className="col-span-10 px-10">
        ...
        {showSuggestions && (
          <div className="fixed bg-white py-2 px-2 w-[32rem] shadow rounded-lg border border-gray-100">
            <ul>
              {suggestions.map((suggestion) => (
                <li
                  key={suggestion}
                  className="my-1 px-3 shadow-sm hover:bg-gray-100"
                >
                  {suggestion}
                </li>
              ))}
